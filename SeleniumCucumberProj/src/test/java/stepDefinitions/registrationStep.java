...
public class registrationStep {
	...
	public void tearDown(Scenario scenario) throws IOException {
		...
		if (scenario.isFailed()) {
			...
			File filePerm = new File(
					"C:\\Users\\IndrajaChinnacheruku\\Downloads\\SeleniumCucumberProj\\FailedScreenshot\\"
	...
	public void the_registration_confirmation_page_and_we_validate_the_and(String firstName, String lastName)
		...
		Assert.assertEquals(firstName.contains("Indu"), actualText.contains("Indu"));
		Assert.assertEquals(lastName.contains("CR"), actualText.contains("CR"));
		Thread.sleep(5000L);
	...
	public void i_fill_the_field(String userid) {
		driver.findElement(By.xpath("//*[@id=\"login\"]")).sendKeys(userid);
	}
	@And("I provide \"([^\\\"]*)\" field")
	public void i_provide_field(String pwd) {
	...
	public void user_navigated_to_My_courses_page_and_I_click_on_compose() {
	driver.findElement(By.xpath("//*[@href='http://elearningm1.upskills.in/main/messages/new_message.php']")).click();
	}
	 
	@Then("I enter \"([^\\\"]*)\" field")
	public void i_enter_field(String sendto) {
	...
	public void i_enter_the_field(String Subject) {
	driver.findElement(By.xpath("//*[@id=\"compose_message_title\"]")).sendKeys(Subject);
	}
		
	@Then("I send attachment to receipient")
	public void i_send_attachment_to_receipient(String Message) {
	driver.findElement(By.xpath("//*[@name=\"attach_1\"]")).sendKeys("C:\\Users\\IndrajaChinnacheruku\\Documents");
	}
